const DISTORTION_DEFINITIONS: Record<string, { definition: string; example: string }> = {
  ...
  'Обесценивание позитивного': {
    definition: 'Игнорирование или принижение положительных событий, достижений или качеств.',
    example: '«Меня похвалили за доклад, но это просто повезло — любой бы справился.»',
  },
  'Поспешные выводы': {
    definition: 'Склонность делать негативные выводы без достаточных оснований, в том числе «чтение мыслей» и «предсказание будущего».',
    example: '«Он не ответил на сообщение — значит, я ему безразличен.»',
  },
};
