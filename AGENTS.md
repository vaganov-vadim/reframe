...
5. **⚠️ ВСЕГДА сначала обновляй speckit-артефакты, потом код.** Никакой реализации до обновления spec/plan/tasks.
6. **⚠️ Новая фича → acceptance-тест ДО реализации.** Без E2E/acceptance-теста PR не мёрджится.
